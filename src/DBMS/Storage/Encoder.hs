...
encodeRowValue ColumnSchema{schematype=SInt32    } (VInt32 d)  = encodeMaybeInt d
encodeRowValue ColumnSchema{schematype=SVarchar n} (VString s) = encodeMaybeVarchar n s
